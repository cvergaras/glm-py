    ...
    def _default_converters(self) -> dict:
        default_converters = {
            ...
            "init_profiles": {
                ...
                "the_heights": NMLWriter.write_nml_list,
    ...
    def _default_converters(self) -> dict:
        ...
        default_converters = {
            ...
            "mixing": {
                ...
                "coef_mix_shreq": NMLReader.read_nml_float,
            ...
            "init_profiles": {
                ...
                "num_heights": NMLReader.read_nml_int,
                "the_depths": lambda x: NMLReader.read_nml_list(
                    x, NMLReader.read_nml_float
                ),
                "the_heights": lambda x: NMLReader.read_nml_list(
                    x, NMLReader.read_nml_float
                ),
            ...
            "snowice": {
                ...
                "min_ice_thickness": NMLReader.read_nml_float,
                "dt_iceon_avg": NMLReader.read_nml_float,
                "avg_surf_temp_thres": NMLReader.read_nml_float
            },
            "meteorology": {
